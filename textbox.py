...
def multiLineSurface(string, font, rect, fontColour, surface, offset, justification=0):
    ...
    for line in finalLines:
        ...
        if justification == 0:
            surface.blit(tempSurface, (0 + offset[0], accumulatedHeight + offset[1]))
        elif justification == 1:
            surface.blit(tempSurface, ((rect.width - tempSurface.get_width()) / 2 + offset[0], accumulatedHeight + offset[1]))
        elif justification == 2:
            surface.blit(tempSurface, (rect.width - tempSurface.get_width() + offset[0], accumulatedHeight + offset[1]))
        else:
